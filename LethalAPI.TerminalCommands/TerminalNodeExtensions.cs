// -----------------------------------------------------------------------
// <copyright file="TerminalNodeExtensions.cs" company="LethalAPI Modding Community">
...
/// <summary>
/// Provides a collection of Builder extension methods for <see cref="TerminalNode"/>.
/// </summary>
public static class TerminalNodeExtensions
{
    ...
    /// <summary>
    /// Enables redirecting the next terminal response to the item at index 0 in <see cref="TerminalNode.terminalOptions"/>.
    /// </summary>
    /// <param name="node">Terminal node to modify.</param>
    /// <returns>Original terminal node.</returns>
    /// <remarks>
